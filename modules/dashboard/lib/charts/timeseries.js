  ...
  constructor(config) {
    ...
    */
    ...
    self.dates = [
      ...new Set(
        self.data.map((datum) =>
          D3.timeSunday
            .ceil(new Date(datum[self.accessors.x.key]))
            .toDateString(),
        ),
      ),
    ...
    */
    ...
    self.xAxis = self.svg
      ...
      .call(
        D3.axisBottom(self.datetime)
          .tickFormat(self.dateformat)
          .tickSizeOuter(0)
          .tickPadding(4),
      );
...
*/
  ...
  mapData(data, filter) {
    ...
    const filteroptions = unique.object
      .values(data, "filterby")
      .toSorted(sorting.strings.natural);
    const groups = unique.object
      .values(data, "group")
      .toSorted(sorting.strings.natural);
    const colors = unique.object
      .values(data, "color")
      .toSorted(sorting.strings.natural);
